...
$lang = array(
	...
	'info' => 'Diese Challenge ist die Fortsetzung von &quot;Blinded by the lighter&quot;.<br/>
Wieder musst du einen MD5-Passwort-Hash aus der Datenbank auslesen.<br/>
Diesmal darfst du für diese SQL-Injection höchstens %s Abfragen verwenden.<br/>
Außerdem musst du die Aufgabe %s Mal in Folge erfüllen, um die Challenge zu lösen.<br/>
Wieder erhältst du den <a href="%s">Quelltext</a> des verwundbaren Skripts, ebenfalls als <a href="%s">hervorgehobene Version</a>.<br/>
